...
func testSetup() (chan *nats.Msg, chan *nats.Msg) {
	...
	nc.ChanSubscribe("instance.update.aws.done", doneChan)
	nc.ChanSubscribe("instance.update.aws.error", errChan)
	...
	Convey("Given I an event", t, func() {
		Convey("With valid fields", func() {
			...
			Convey("When completing the event", func() {
				...
				e.Process(valid)
				e.Complete()
				Convey("It should produce a instance.update.aws.done event", func() {
			...
			Convey("When erroring the event", func() {
				...
				Convey("It should produce a instance.update.aws.error event", func() {
					msg, timeout := waitMsg(errored)
					So(msg, ShouldNotBeNil)
